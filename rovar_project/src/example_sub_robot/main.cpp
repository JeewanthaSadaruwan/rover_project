/*
 * EXAMPLE SUB ROBOT - ESP-NOW Motor Control Receiver
...
// ================================
// MOTOR PIN DEFINITIONS (L298 on Sub Robot)
// ================================
// Left Motor
#define MOTOR_LEFT_PWM      25    // ENA - Left motor speed
#define MOTOR_LEFT_IN1      32    // IN1 - Left motor direction
#define MOTOR_LEFT_IN2      33    // IN2 - Left motor direction

// Right Motor  
#define MOTOR_RIGHT_PWM     4     // ENB - Right motor speed
#define MOTOR_RIGHT_IN1     12    // IN3 - Right motor direction
#define MOTOR_RIGHT_IN2     15    // IN4 - Right motor direction
...
// ================================
// Converts raw joystick (0-4095) to motor speed (-255 to 255)
int mapJoystick(int value, int deadzone = 200) {
  // Center is ~2048, range 0-4095
...
// Arcade drive: throttle + steering mixing
...
void onDataSent(const uint8_t *mac_addr, esp_now_send_status_t status) {
  // ACK sent callback (optional logging)
}
...
void setup() {
  ...
  Serial.println("\n========================================");
  Serial.println("  EXAMPLE SUB ROBOT - Motor Receiver");
  Serial.println("========================================\n");
  
  // Initialize motors
  initMotors();
  Serial.println("[Motors] Initialized");
  Serial.println("  LEFT:  PWM=12, IN1=14, IN2=27");
  Serial.println("  RIGHT: PWM=26, IN1=25, IN2=33");
  ...
  Serial.println("[WiFi] >>> Use this MAC in sub_robot_control! <<<\n");
...
String getMotionState(int throttle, int steering) {
  // Determine motion state based on throttle and steering values
